...
def collate_fn(batch):
    ...
    :return: a tensor of images, lists of varying-size tensors of bounding boxes, labels, and domain information
    """
...
class DGFasterRCNN(LightningModule):
    ...
    def train_dataloader(self):
      ...
      for i in range(num_train_sample_batches):
        ...
        # We ensure to provide same batch of data to main detector
        # as well as the regularisation module we use
        for index in batch:
...
NET_FOLDER = './Cityscapes'
weights_file = 'best_prop'
import os
detector = DGFasterRCNN(9)
...
test_dataset = CityScapesDatasetTest('../datasets/Annots/cityscapes_foggy_val.csv', root='../datasets/cityscapes_foggy/val/', transform=valid_transform)
